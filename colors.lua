--Based on T-Engine"s color palette (see http://te4.org/wiki/Colors)
...
defineColor("SLATE", 140, 140, 140)
defineColor("ORANGE", 255, 119, 0)
defineColor("RED", 201, 0, 0)
defineColor("GREEN", 0, 134, 69)
defineColor("BLUE", 0, 0, 227)
defineColor("UMBER", 142, 69, 0)
defineColor("LIGHT_DARK", 80, 80, 80)
defineColor("LIGHT_SLATE", 209, 209, 209)
defineColor("VIOLET", 192, 0, 175)
defineColor("YELLOW", 255, 255, 0)
defineColor("LIGHT_RED", 255, 0, 104)
defineColor("LIGHT_GREEN", 0, 255, 0)
defineColor("LIGHT_BLUE", 81, 221, 225)
defineColor("LIGHT_UMBER", 215, 142, 69)
defineColor("DARK_UMBER", 87, 94, 37)
...
defineColor("DARK_BLUE", 0, 0, 147)
defineColor("ROYAL_BLUE", 0, 108, 255)
